...
| 4 | Stitch-designed React commercial UI | in-progress | 2, 3 | 5 screens via `/stitch-design` → shadcn/ui React → FastAPI. Wizard core complete (5/5 screens: Upload, Prepare, Storyboard, Generate, Review+Export). Non-wizard Settings screen remains as sub-plan 6. |
