...
| 4 | Stitch-designed React commercial UI | in-progress | 2, 3 | 5 screens via `/stitch-design` → shadcn/ui React → FastAPI. Sub-plans 1 (Upload) + 2 (Prepare) + 3 (Storyboard) + 4 (Generate) done; 2 remaining (Review+Export, Settings). |
